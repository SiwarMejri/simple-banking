...
if __name__ == "__main__":
    ...
    parser.add_argument("--trivy-image-json", required=True)
    parser.add_argument("--sonarqube-project", required=True)
    parser.add_argument("--output", default="full_report.pdf")
    parser.add_argument("--sonar-url", default="http://192.168.240.139:9000")
